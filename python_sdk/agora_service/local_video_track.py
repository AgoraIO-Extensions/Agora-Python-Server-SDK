...
agora_local_video_track_set_video_encoder_config.argtypes = [AGORA_HANDLE, ctypes.POINTER(video_encoder_config)]
...
agora_local_video_track_enable_simulcast_stream.argtypes = [AGORA_HANDLE, ctypes.c_int, ctypes.POINTER(simulcast_stream_config)]
...
agora_local_video_track_update_simulcast_stream.argtypes = [AGORA_HANDLE, ctypes.c_int, ctypes.POINTER(simulcast_stream_config)]
...
agora_local_video_track_get_statistics.restype = ctypes.POINTER(local_video_track_stats)
...
agora_local_video_track_destroy_statistics.argtypes = [AGORA_HANDLE, ctypes.POINTER(local_video_track_stats)]
